...
(function ($) {
    ...
    k.o = function () {
        ...
        this.run = function () {
            ...
            this.o = $.extend({min: this.$.data("min") || 0, max: this.$.data("max") || 100, stopper: true, readOnly: this.$.data("readonly"), cursor: this.$.data("cursor") === true && 30 || (this.$.data("cursor") || 0), thickness: this.$.data("thickness") || 0.35, width: this.$.data("width") || 200, height: this.$.data("height") || 200, displayInput: this.$.data("displayinput") == null || this.$.data("displayinput"), displayPrevious: this.$.data("displayprevious"), fgColor: this.$.data("fgcolor") ||
                "#87CEEB", inline: false, id: this.$.data("id"), draw: null, change: null, cancel: null, release: null}, this.o);
            if (this.$.is("fieldset")) {
                this.v = {};
            ...
            this.$.wrap($('<div style="margin-right: 20px;' + (this.o.inline ? "display:inline;" : "") + "width:" + this.o.width + "px;height:" + this.o.height + 'px;"></div>')).before(this.$c);
            this.$.wrap($("hola"));
    ...
    k.Dial = function () {
        ...
        this.PI2 = 2 * Math.PI;
        this.extend = function () {
            this.o = $.extend({bgColor: this.$.data("bgcolor") || "#EEEEEE", angleOffset: this.$.data("angleoffset") || 0, angleArc: this.$.data("anglearc") ||
                360, inline: true}, this.o)
        };
        this.val = function (v) {
            if (null != v) {
        ...
        this.listen =
            function () {
                ...
                this.$.bind("keydown", function (e) {
                    var kc = e.keyCode;
                    if (kc >= 96 && kc <= 105)kc = e.keyCode = kc - 48;
                    ...
                    } else s.$.val() > s.o.max && s.$.val(s.o.max) || s.$.val() < s.o.min && s.$.val(s.o.min)
                });
        ...
        this.init = function () {
            if (this.v <
                this.o.min || this.v > this.o.max)this.v = this.o.min;
            this.$.val(this.v);
        ...
        this.draw = function () {
            ...
            this.o.cursor && ((sat = eat - this.cursorExt) && (eat =
                eat + this.cursorExt));
            c.beginPath();
            ...
            c.arc(this.xy, this.xy, this.radius,
                sat, eat, false);
            c.stroke()
        };
...
(function ($) {
    $.fn.ccountdown = function (_yr, _m, _d) {
        ...
        function _changeTime() {
            ...
            _dday = Math.floor(_dd / (60 * 60 * 1E3 * 24) * 1);
            _dhour = Math.floor(_dd % (60 * 60 * 1E3 * 24) / (60 * 60 * 1E3) * 1);
            _dmin = Math.floor(_dd % (60 * 60 * 1E3 * 24) % (60 * 60 * 1E3) / (60 * 1E3) * 1);
            _dsec = Math.floor(_dd % (60 * 60 * 1E3 * 24) % (60 * 60 * 1E3) % (60 * 1E3) / 1E3 * 1);

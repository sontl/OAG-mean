...
angular.module('mean.artworks').
    ...
    directive('artSwitcher', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/switcher.html'
        };
    }]).
    directive('artWrapper', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/wrapper.html'
        };
    }]).
    directive('artFeaturedArtworks', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/featured-artwork-1.html'
        };
    }]).
    directive('artWrapperSlider', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/wrapper-slider-1.html'
        };
    }]).
    directive('artWrapperGallery4Columns', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/wrapper-gallery-4-columns.html'
        };
    }]).
    directive('artFeaturedArtists', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/featured-artists.html'
        };
    }]).
    directive('artWrapperShop', [ function () {
        return {
            ...
            templateUrl : '/artworks/views/wrapper-shop-1.html'
        };
    }]).
